...
#define D_EM_ON HAL_GPIO_WritePin(D_EMITTER_GPIO_Port, D_EMITTER_Pin, GPIO_PIN_SET)
#define D_EM_OFF HAL_GPIO_WritePin(D_EMITTER_GPIO_Port, D_EMITTER_Pin, GPIO_PIN_RESET)
#define L_EM_ON HAL_GPIO_WritePin(L_EMITTER_GPIO_Port, L_EMITTER_Pin, GPIO_PIN_SET)
#define L_EM_OFF HAL_GPIO_WritePin(L_EMITTER_GPIO_Port, L_EMITTER_Pin, GPIO_PIN_RESET)
#define R_EM_ON HAL_GPIO_WritePin(R_EMITTER_GPIO_Port, R_EMITTER_Pin, GPIO_PIN_SET)
#define R_EM_OFF HAL_GPIO_WritePin(R_EMITTER_GPIO_Port, R_EMITTER_Pin, GPIO_PIN_RESET)
